...
const Social = () => {
  return (
    <div className='fixed flex flex-col items-center mt-auto md:justify-center gap-y-4 h-max md:right-[2%] top-3 md:top-0 md:z-50 w-full md:w-16 md:max-w-md md:h-screen'>
